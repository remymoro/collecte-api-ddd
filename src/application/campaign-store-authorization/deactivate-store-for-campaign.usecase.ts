// src/application/campaign-store-authorization/deactivate-store-for-campaign.usecase.ts
...
export interface DeactivateStoreForCampaignInput {
  campaignId: string;
  storeId: string;
}
...
@Injectable()
export class DeactivateStoreForCampaignUseCase {
  constructor(
  ...
  async execute(input: DeactivateStoreForCampaignInput): Promise<void> {
    // ============================
    ...
    // ============================
    // 3️⃣ Charger l'autorisation existante
    // ============================
